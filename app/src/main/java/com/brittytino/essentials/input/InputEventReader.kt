package com.brittytino.essentials.input
...
import com.brittytino.essentials.shizuku.ShizukuProcessHelper
...
class InputEventReader(private val devicePath: String) {
    ...
    fun open(): Boolean = try {
        process = com.brittytino.essentials.utils.ShellUtils.newProcess(
            com.brittytino.essentials.EssentialsApp.context,
