...
import com.brittytino.essentials.services.InputEventListenerService
        ...
        RoundedCardContainer(spacing = 2.dp) {
            ...
            AnimatedVisibility(
                ...
                Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
                    val isRootEnabled =
                        com.brittytino.essentials.utils.ShellUtils.isRootEnabled(context)
                    IconToggleItem(
                        ...
                        onCheckedChange = { enabled ->
                            if (enabled) {
                                ...
                                val shellIsAvailable =
                                    com.brittytino.essentials.utils.ShellUtils.isAvailable(context)
                                ...
                                if (shellHasPermission) {
                                    ...
                                    // Root logic
                                    viewModel.setButtonRemapUseShizuku(true, context)
                                    com.brittytino.essentials.utils.ShellUtils.runCommand(context, "id")
                                } else {
