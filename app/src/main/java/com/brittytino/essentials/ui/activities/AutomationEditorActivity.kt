...
import com.brittytino.essentials.domain.diy.DIYRepository
import com.brittytino.essentials.domain.diy.Trigger
import com.brittytino.essentials.domain.diy.State as DIYState
import com.brittytino.essentials.ui.components.containers.RoundedCardContainer
import com.brittytino.essentials.ui.components.menus.SegmentedDropdownMenu
import com.brittytino.essentials.ui.components.menus.SegmentedDropdownMenuItem
import com.brittytino.essentials.ui.components.pickers.SegmentedPicker
import com.brittytino.essentials.ui.components.sheets.DimWallpaperSettingsSheet
...
import com.brittytino.essentials.ui.components.cards.AppToggleItem
...
class AutomationEditorActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val viewModel: com.brittytino.essentials.viewmodels.MainViewModel = androidx.lifecycle.viewmodel.compose.viewModel()
                ...
                Scaffold(
                    ...
                    Column(modifier = Modifier
                        ...
                        if (showDeviceEffectsSettings && configAction is Action.DeviceEffects) {
                            com.brittytino.essentials.ui.components.sheets.DeviceEffectsSettingsSheet(
