package com.brittytino.essentials.domain.registry

import android.content.Context
import com.brittytino.essentials.R
import com.brittytino.essentials.domain.model.Feature
import com.brittytino.essentials.domain.model.SearchSetting
...
object FeatureRegistry {
    val ALL_FEATURES = listOf(
        ...
        object : Feature(
            ...
            permissionKeys = if (ShellUtils.isRootEnabled(com.brittytino.essentials.EssentialsApp.context)) listOf("ROOT", "NOTIFICATION_LISTENER") else listOf("SHIZUKU", "NOTIFICATION_LISTENER"),
            ...
            override fun isToggleEnabled(viewModel: MainViewModel, context: Context) =
                com.brittytino.essentials.utils.ShellUtils.hasPermission(context) && viewModel.isNotificationListenerEnabled.value
        ...
        object : Feature(
            ...
            permissionKeys = if (ShellUtils.isRootEnabled(com.brittytino.essentials.EssentialsApp.context)) listOf("ACCESSIBILITY", "ROOT") else listOf("ACCESSIBILITY", "SHIZUKU"),
            showToggle = false,
            searchableSettings = listOf(
                SearchSetting(
        ...
        object : Feature(
            ...
            permissionKeys = if (ShellUtils.isRootEnabled(com.brittytino.essentials.EssentialsApp.context)) listOf("ROOT") else listOf("SHIZUKU"),
            searchableSettings = listOf(
                SearchSetting(
...
,
            ...
            override fun isEnabled(viewModel: MainViewModel) = true
            override fun isToggleEnabled(viewModel: MainViewModel, context: Context) =
                com.brittytino.essentials.utils.ShellUtils.hasPermission(context)
            override fun onToggle(viewModel: MainViewModel, context: Context, enabled: Boolean) {}
        },
        ...
        object : Feature(
            ...
            override fun onToggle(viewModel: MainViewModel, context: Context, enabled: Boolean) {}
            override fun onClick(context: Context, viewModel: MainViewModel) {
                context.startActivity(android.content.Intent(context, com.brittytino.essentials.ui.composables.watermark.WatermarkActivity::class.java))
            }
        }
    )
}