...
import com.brittytino.essentials.utils.OverlayHelper
...
class NotificationLightingService : Service() {
    ...
    private fun buildNotification(): Notification {
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            .setSmallIcon(com.brittytino.essentials.R.drawable.rounded_magnify_fullscreen_24)
            .setContentTitle("")
            .setContentText("")
            ...
            val color = when {
                ...
                colorMode == NotificationLightingColorMode.CUSTOM -> customColor
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                        ...
                        getColor(com.brittytino.essentials.R.color.purple_500)
                    }
                }
            }
