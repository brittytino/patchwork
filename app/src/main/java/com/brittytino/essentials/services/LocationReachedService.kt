...
import com.brittytino.essentials.data.repository.LocationReachedRepository
import com.brittytino.essentials.MainActivity
...
class LocationReachedService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_STOP = "com.brittytino.essentials.STOP_LOCATION_REACHED"
    ...
    private fun updateProgress(alarm: com.brittytino.essentials.domain.model.LocationAlarm) {
    ...
    private fun triggerArrivalAlarm() {
        ...
        val fullScreenIntent = Intent(this, com.brittytino.essentials.ui.activities.LocationAlarmActivity::class.java).apply {
