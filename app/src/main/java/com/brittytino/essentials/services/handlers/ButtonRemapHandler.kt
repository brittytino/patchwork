...
class ButtonRemapHandler(
    ...
    fun onKeyEvent(event: KeyEvent): Boolean {
        ...
        val shellReady = com.brittytino.essentials.utils.ShellUtils.isAvailable(service) && com.brittytino.essentials.utils.ShellUtils.hasPermission(service)
        ...
        val useShell = isButtonRemapUseShizuku || com.brittytino.essentials.utils.ShellUtils.isRootEnabled(service)
