    ...
    suspend fun execute(context: Context, action: Action) {
        when (action) {
            ...
            is Action.DimWallpaper -> {
                com.brittytino.essentials.utils.ShellUtils.runCommand(context, "cmd wallpaper set-dim-amount ${action.dimAmount}")
            }
                     ...
                     if (nm.isNotificationPolicyAccessGranted) {
                         try {
                              if (action.enabled) {
                                  ...
                                  val componentName = android.content.ComponentName(context, com.brittytino.essentials.services.EssentialsConditionProvider::class.java)
                                  val conditionUri = com.brittytino.essentials.services.EssentialsConditionProvider.CONDITION_URI
                                  ...
                                  val ruleBuilder = android.app.AutomaticZenRule.Builder("Essentials Focus", conditionUri)
                                      ...
                                      .setConfigurationActivity(android.content.ComponentName(context, com.brittytino.essentials.MainActivity::class.java))
                                  ...
                                  com.brittytino.essentials.services.EssentialsConditionProvider.setConditionState(context, true)
                                  ...
                                  com.brittytino.essentials.services.EssentialsConditionProvider.setConditionState(context, false)
