...
import com.brittytino.essentials.services.automation.executors.CombinedActionExecutor
    ...
    private fun checkAppLock(packageName: String) {
        ...
        if (isLocked && !authenticatedPackages.contains(packageName)) {
            ...
            val intent = Intent().apply {
                component = ComponentName(service, "com.brittytino.essentials.AppLockActivity")
