...
import com.brittytino.essentials.ui.components.linkActions.LinkPickerScreen
import com.brittytino.essentials.ui.composables.configs.StatusBarIconSettingsUI
import com.brittytino.essentials.ui.composables.configs.CaffeinateSettingsUI
import com.brittytino.essentials.ui.composables.configs.ScreenOffWidgetSettingsUI
import com.brittytino.essentials.ui.composables.configs.NotificationLightingSettingsUI
import com.brittytino.essentials.ui.composables.configs.SoundModeTileSettingsUI
import com.brittytino.essentials.ui.composables.configs.QuickSettingsTilesSettingsUI
import com.brittytino.essentials.ui.composables.configs.ButtonRemapSettingsUI
import com.brittytino.essentials.ui.composables.configs.DynamicNightLightSettingsUI
import com.brittytino.essentials.ui.composables.configs.SnoozeNotificationsSettingsUI
import com.brittytino.essentials.ui.composables.configs.LocationReachedSettingsUI
import com.brittytino.essentials.ui.composables.configs.BatteriesSettingsUI
import com.brittytino.essentials.viewmodels.CaffeinateViewModel
...
import com.brittytino.essentials.ui.composables.configs.AppLockSettingsUI
import com.brittytino.essentials.ui.composables.configs.ScreenLockedSecuritySettingsUI
import com.brittytino.essentials.ui.composables.configs.KeyboardSettingsUI
            ...
            EssentialsTheme(pitchBlackTheme = isPitchBlackThemeEnabled) {
                ...
                LaunchedEffect(featureId, isAccessibilityEnabled, isWriteSecureSettingsEnabled, isOverlayPermissionGranted, isNotificationLightingAccessibilityEnabled, isNotificationListenerEnabled) {
                    val hasMissingPermissions = when (featureId) {
                        ...
                        "Freeze" -> !com.brittytino.essentials.utils.ShellUtils.hasPermission(context)
                ...
                if (showPermissionSheet) {
                    val permissionItems = when (featureId) {
                        ...
                        "Freeze" -> {
                            val isRootEnabled = com.brittytino.essentials.utils.ShellUtils.isRootEnabled(context)
                            listOf(
                                if (isRootEnabled) {
                                    PermissionItem(
                ...
                Scaffold(
                    ...
                    Column(
                        ...
                        when (featureId) {
                            ...
                            "Freeze" -> {
                                com.brittytino.essentials.ui.composables.configs.FreezeSettingsUI(
                                    viewModel = viewModel,
                                    modifier = Modifier.padding(top = 16.dp),
                                    highlightKey = highlightSetting
                                )
