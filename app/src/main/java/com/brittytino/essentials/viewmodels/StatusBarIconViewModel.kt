...
import com.brittytino.essentials.ui.components.pickers.NetworkType
import com.brittytino.essentials.utils.resetAllIconVisibilities
import com.brittytino.essentials.utils.updateIconBlacklistSetting
...
class StatusBarIconViewModel : ViewModel() {
    ...
    private fun canWriteSecureSettings(context: Context): Boolean {
        return com.brittytino.essentials.utils.PermissionUtils.canWriteSecureSettings(context)
    }
