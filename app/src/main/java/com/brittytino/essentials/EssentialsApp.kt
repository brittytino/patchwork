...
class EssentialsApp : Application() {
    ...
    override fun onCreate() {
        ...
        com.brittytino.essentials.utils.LogManager.init(this)
        
        // Init Automation
        com.brittytino.essentials.domain.diy.DIYRepository.init(this)
        com.brittytino.essentials.services.automation.AutomationManager.init(this)
